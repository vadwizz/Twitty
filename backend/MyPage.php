...
<body>
    ...
    <div class="container row">
        <section class="left col-5">
            ...
            </div><button class="exit">Вийти</button>
        ...
        <section class="right col-7">
            <form action="twitts.php" class="form" name="form" method="POST">
                <textarea name="twitt" placeholder="Напишіть щось" id="twitt" class="area" cols="30" rows="3"></textarea><br>
                <input name="twitt-btn" disabled="true" type="submit" value="Поділитися" class="sub">

            </form>
            <div class="twitts">
                <div class="allTwitts"><?= require_once('../backend/MyTwitty.php'); ?></div>
